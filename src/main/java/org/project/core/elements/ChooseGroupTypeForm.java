...
public class ChooseGroupTypeForm extends LoadableElements {
    ...
    private static final String CREATE_PAGE_BLOCK_ON_CHOOSE_GROUP_TYPE_FORM = "";
    private static final String CREATE_INTEREST_ON_CHOOSE_GROUP_TYPE_FORM = "";
    private static final String CREATE_HAPPENING_ON_CHOOSE_GROUP_TYPE_FORM = "";
    private static final String CREATE_PAGE_FOR_CREATE_GROUP_PAGE = "";
    private static final String CREATE_INTEREST_FOR_CREATE_GROUP_INTEREST = "";
    private static final String CREATE_HAPPENING_FOR_CREATE_GROUP_HAPPENING = "";
    ...
    public ChooseGroupTypeForm check() {
        ...
        $(CREATE_INTEREST)
                .shouldBe(visible.because(CREATE_INTEREST_ON_CHOOSE_GROUP_TYPE_FORM));
        $(CREATE_HAPPENING)
